...
urlpatterns = [
    ...
    path('servicerecipt/', views.servicerecipt, name='servicerecipt'),
    path('getprovidedserviceviewbyPatientId/', views.getprovidedserviceviewbyPatientId, name='getprovidedserviceviewbyPatientId'),
